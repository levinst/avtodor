        ...
        <form>
            <div class="flex w-full">
                ...
                <div class="w-1/2 ml-2">
                    ...
                    <select wire:model.defer="category_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2">
                ...
                <tr>
                    <td>
                        <div class="flex justify-between">
                            ...
                            <div class="w-1/2 px-1 border-l border-l-gray-300">
                                {{ $item['category']['title'] }}
                            </div>
                        </div>
                    </td>
