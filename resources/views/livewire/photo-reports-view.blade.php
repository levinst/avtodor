...
@push('scripts')
    <script>
        jQuery('.photo-view img').replaceWith(function(){
	        var thumb = this.src,
...
<div class="lg:max-w-7xl lg:mt-8 lg:mr-6">
    <div class="grid grid-cols-1 w-full mb-6  gap-2 border-b lg:border-0">
        <div class="">
            <div class="text-sm font-medium text-gray-600">
                {{ $photoreports['created_at']->format('d/m/Y') }}
            </div>
    ...
    <a href="{{ route('photoreportsAll') }}" class="flex items-center mt-6 text-indigo-500">
        ...
        <p class="ml-4 mt-3">Все фотоотчеты</p>
    </a>
</div>
