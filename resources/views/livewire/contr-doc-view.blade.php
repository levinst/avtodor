...
<div class="lg:max-w-7xl lg:mt-8 lg:mr-6">
    <div class="grid grid-cols-1 w-full mb-6  gap-2 border-b lg:border-0">
        <div class="">
            <div class="text-sm font-medium text-gray-600">
                {{ $contrdoc['created_at']->format('d/m/Y') }}
            </div>
    ...
    <div>
        <div class="$contrdoc-view">
            {!! $contrdoc['text'] !!}
        </div>
    </div>
    <a href="{{ route('contrdocAll') }}" class="flex items-center mt-6 text-indigo-500">
        ...
        <p class="ml-4 mt-3">Все документы</p>
    </a>
</div>
