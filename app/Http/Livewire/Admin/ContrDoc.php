...
class ContrDoc extends Component
{
    ...
    public $contr_cat_doc_id, $title, $slug, $text, $selected_id, $image, $created_at;
...
//
    public function store()
    {
        ...
        ModelContrDoc::create([
            'title' => $this->title,
            'slug' => time().'-'.$this->slug,
            'image' => $image,
            'text' => $this->text,
            'created_at' => $this->created_at,
            'contr_cat_doc_id' => $this->contr_cat_doc_id,
        ]);
...
//
    public function update()
    {
        ...
        if ($this->selected_id != null) {
            ...
            $model = ModelContrDoc::find($this->selected_id);
...
//
    ...
    public function render()
    {
        ...
        $contrdocs = ModelContrDoc::where('title', 'like', $searchTerm)->orderBy('created_at', 'desc')->paginate(30);

        return view('livewire.admin.contr-doc', [
            'contrdocs' => $contrdocs,
